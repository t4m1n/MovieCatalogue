...
public class FragmentTvshow extends Fragment{
    ...
    private void prepare() {
        ...
        dataDesc = getResources().getStringArray(R.array.tv_data_description);
        dataRelease = getResources().getStringArray(R.array.tv_data_release);
        dataPhoto = getResources().obtainTypedArray(R.array.tv_data_photo);
    }
